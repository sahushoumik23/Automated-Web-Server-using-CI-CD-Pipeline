...
I was facing problems with this one as the docker commands were not executing...One of the members of the MLOPs Training named Raghav Gupta helped me for that.... 

He mentioned that my ls was unable to acquire all the files in the folder, so he suggested to use "ls -A".... This will show all the files(even hidden files) present in th path given.... 

So as I have used ls -A /shoumik....this means that it will show all the files including hidden files and my condition can help me do the rest to complete the job.... 
...
<h4> Thank you all the MLOPs group members to help me build this task and complete the project...<br>
